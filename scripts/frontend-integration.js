 ...
 * This file demonstrates how to integrate Madlad400 with a web frontend
 */

// For React/Vue/Angular applications
export class Madlad400Client {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new Madlad400Client(provider, contractAddress);
